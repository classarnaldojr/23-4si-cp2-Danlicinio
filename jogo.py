#biblioteca OpenCV
import cv2
#framework criado pelo Google de código aberto, capax de detectar elementos em imagem e vídeo
import mediapipe as mp
#biblioteca Numpy
import numpy as np
#processamento de imagens, tranlação, rotação, redimensionamento, esqueletização e exibição de imagem 
import imutils
...
#identificar se pedra, papel e tesoura
...
#identificar dentificar as mãos
with mp_hands.Hands(
    model_complexity=0, 
